...
- Train a CGCNN model with a customized dataset on the Paddle framework.
- Predict material properties of new crystals with a pre-trained CGCNN model on the Paddle framework.
